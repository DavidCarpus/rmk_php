...
echo headSegments("Knife Care", array("Style.css"), "print.css");
?>
 ...
 <div class="mainbody">
	<div class="centerblock">
		...
		<div class="content">
			...
			<br /><br />
			<span class="cap-g">F</span>or the sheath use shoe polish or saddle soap. We do NOT advise using oil because it will soften the leather and keep the sheath flexible, making it difficult to sheathe the knife. To darken the sheath, use dark polish or dye.
			<br /><br />
			...
			<a href='knifesharpening.php'>Sharpening your knife</a>
		</div>
	</div>
	<?php echo footer(); ?>
</div>
