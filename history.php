 ...
 <div class="mainbody">
	<div class="centerblock">
		...
		<div class="content">
			...
			So I bought it.
			<br /><br />
			<img class='floatleft' width=217 src='<?php echo getBaseImageDir(); ?>/historypic.jpg'>
			...
			<br /><br />
			<span class="cap-g">B</span>ack then, his name wasn't widely known. But I was truly impressed with what he'd created at a time when virtually all knives were being mass produced.
			<br /><br />
			...
			<br /><br />
			<span class="cap-g">T</span>hrough it all, I managed our family's citrus groves and I continued to think of my hand-made knives as an avocation.
			<br /><br />
			...
			<br /><br />
			<img class='floatright' width=170 height=155 src='<?php echo getBaseImageDir(); ?>/BoAndGary.jpg'>
			...
			<br /><br />
			<span class="cap-g">B</span>ut now, more than ever, I wanted Randall Made to stand for quality and dependability, because servicemen were telling me how much they relied on my knives.
			<br /><br />
			...
			<br /><br />
			<span class="cap-g">F</span>or some years now, my son, Gary, has been instrumental in the business. He is honored, as I am, that Randall Made knives are on display in museums, as well as in many private collections of fine weapons and armor.
			<br /><br />
			...
			<br /><br />
			<span class="cap-g">B</span>ut I'm most grateful to those who have made suggestions on ways to improve our knives. Even though some have said "they're perfect," we know there is always room for refinement.
			<br /><br />
			...
			<br /><br />
			<img class='floatleft' width=120 height=165 src='<?php echo getBaseImageDir(); ?>/BO.jpg'>
			W. D. "Bo" Randall passed away December 25, 1989 at his home after visiting with all his family earlier in the day.
			<br /><br />
			<span class="cap-g">B</span>o and his son Gary have managed the business side by side for over twenty-five years. Gary continues the tradition of hand crafting knives that bear the Randall Made trademark along with his sons of the next Randall generation. 
		</div>
	</div>
	<?php echo footer(); ?>
