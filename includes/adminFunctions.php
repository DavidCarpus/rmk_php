...
//	$results[] = array("Done"=>"", "Text"=>"Labels for foreign should have more lines. Seperate out 'state and zip' on seperate line?");
	...
	$results[] = array("Done"=>"2010-05-03", "Text"=>"Order Processing screen:Process and print bar--- not working  -after 1st print  and return to screen, the Payment(red box) still shows qty of 1 ");
	$results[] = array("Done"=>"2010-05-03", "Text"=>"Order Processing screen:unprocessed payment.  Also the Process state—still reflects unprocessed.");
	$results[] = array("Done"=>"2010-05-04", "Text"=>"Decrease margin on Balance Due letter by about an inch");
	$results[] = array("Done"=>"2010-05-04", "Text"=>"Order form, REview request - Fields need to be longer");
	$results[] = array("Done"=>"2010-05-04", "Text"=>"Not submitting orders into Database");
	$results[] = array("Done"=>"", "Text"=>"Eliminate 'duplicates' in the web order processing stuff");
	$results[] = array("Done"=>"", "Text"=>"Order processing screen, 'auto refresh'. (Expire contents)");
